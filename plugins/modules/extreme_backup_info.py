...
- name: List all backups
  stevefulme1.extremenetworks.extreme_backup_info:
...
def main():
    ...
    if resource_id:
        result = client.get("backup", resource_id)
        resources = [result] if result else []
    else:
        resources = client.list("backup", module.params)

    module.exit_json(changed=False, backups=resources)

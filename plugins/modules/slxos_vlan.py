...
---
module: slxos_vlan
short_description: Manage SLX-OS VLANs
description:
    - Manage SLX-OS VLANs.
version_added: "1.0.0"
author:
...
options:
    ...
    host:
        ...
        required: true
    vlan_id:
        description: Unique identifier of the slxos vlan.
        type: str
    name:
...
EXAMPLES = r"""
- name: Create a slxos vlan
  stevefulme1.extremenetworks.slxos_vlan:
    host: api.example.com
    name: my-slxos-vlan
    state: present

- name: Delete a slxos vlan
  stevefulme1.extremenetworks.slxos_vlan:
    host: api.example.com
    vlan_id: "example-id"
    state: absent
...
def main():
    ...
    if state == "present":
        ...
        if resource_id:
            ...
            candidates = client.list("slxos_vlan", {dict(name=module.params.get("name", ""))})
            if candidates:

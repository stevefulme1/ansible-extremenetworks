...
---
module: xiq_device
short_description: Manage ExtremeCloud IQ devices
description:
    - Manage ExtremeCloud IQ devices.
version_added: "1.0.0"
author:
...
options:
    ...
    host:
        ...
        required: true
    device_id:
        description: Unique identifier of the xiq device.
        type: str
    name:
...
EXAMPLES = r"""
- name: Create a xiq device
  stevefulme1.extremenetworks.xiq_device:
    host: api.example.com
    name: my-xiq-device
    state: present

- name: Delete a xiq device
  stevefulme1.extremenetworks.xiq_device:
    host: api.example.com
...
def main():
    ...
    if state == "present":
        ...
        if resource_id:
            ...
            candidates = client.list("xiq_device", {dict(name=module.params.get("name", ""))})
            if candidates:

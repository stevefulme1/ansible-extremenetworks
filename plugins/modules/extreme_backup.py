...
DOCUMENTATION = r"""
---
module: extreme_backup
short_description: Backup Extreme Networks device configurations
description:
    - Backup Extreme Networks device configurations.
version_added: "1.0.0"
author:
...
- name: Create a backup
  stevefulme1.extremenetworks.extreme_backup:
...
def main():
    ...
    if state == "present":
        ...
        if resource_id:
            ...
            candidates = client.list("backup", {dict(name=module.params.get("name", ""))})
            if candidates:

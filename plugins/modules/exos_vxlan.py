...
---
module: exos_vxlan
short_description: Manage ExtremeXOS VXLAN tunnels
description:
    - Manage ExtremeXOS VXLAN tunnels.
version_added: "1.0.0"
author:
...
options:
    ...
    host:
        ...
        required: true
    vni_id:
        description: Unique identifier of the vxlan.
        type: str
    name:
...
EXAMPLES = r"""
- name: Create a vxlan
  stevefulme1.extremenetworks.exos_vxlan:
...
def main():
    ...
    if state == "present":
        ...
        if resource_id:
            ...
            candidates = client.list("vxlan", {dict(name=module.params.get("name", ""))})
            if candidates:

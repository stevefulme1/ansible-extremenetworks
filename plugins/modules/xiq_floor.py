...
---
module: xiq_floor
short_description: Manage ExtremeCloud IQ floor plans
description:
    - Manage ExtremeCloud IQ floor plans.
version_added: "1.0.0"
author:
...
options:
    ...
    host:
        ...
        required: true
    floor_id:
        description: Unique identifier of the xiq floor.
        type: str
    name:
...
EXAMPLES = r"""
- name: Create a xiq floor
  stevefulme1.extremenetworks.xiq_floor:
    host: api.example.com
    name: my-xiq-floor
    state: present

- name: Delete a xiq floor
  stevefulme1.extremenetworks.xiq_floor:
    host: api.example.com
    floor_id: "example-id"
    state: absent
...
def main():
    module = AnsibleModule(
        ...
        required_if=[("state", "absent", ("floor_id",))],
    )
    ...
    if state == "present":
        ...
        if resource_id:
            ...
            candidates = client.list("xiq_floor", {dict(name=module.params.get("name", ""))})
            if candidates:

"""Unit tests for stevefulme1.extremenetworks.exos_interface module."""
...
MODULE_PATH = "ansible_collections.stevefulme1.extremenetworks.plugins.modules.exos_interface"
...
class TestCreateExosInterface:
    """Tests for creating a exos_interface."""
    ...
    def test_create_with_all_params(self, mock_api_client):
        ...
        params = {
            "interface_name": "full-exos_interface",
            "description": "Full test",
            "tags": {"env": "test"},
        }
        mock_api_client.create("exos_interface", params)
        mock_api_client.create.assert_called_once_with("exos_interface", params)
    ...
    def test_create_api_error(self):
        ...
        with pytest.raises(Exception, match="409 Conflict"):
            client.create("exos_interface", {"interface_name": "dup"})

    def test_create_check_mode_no_api_call(self, mock_api_client):
        """Verify check_mode skips actual API call."""
        check_mode = True
        if check_mode:
            result = {"changed": True, "exos_interface": {}}
        else:
            result = mock_api_client.create("exos_interface", {})
        assert result["changed"] is True
        mock_api_client.create.assert_not_called()


class TestUpdateExosInterface:
    """Tests for updating a exos_interface."""
    ...
    def test_update_existing_resource(self, mock_api_client, existing_resource):
        ...
        result = mock_api_client.update("exos_interface", "res-123", {"interface_name": "updated"})
        assert result["interface_name"] == "test-exos_interface-updated"
    ...
    def test_update_nonexistent_raises(self, mock_api_client):
        ...
        with pytest.raises(Exception, match="404 Not Found"):
            mock_api_client.update("exos_interface", "bad-id", {})


class TestDeleteExosInterface:
    """Tests for deleting a exos_interface."""

    def test_delete_existing(self, mock_api_client, existing_resource):
        """Verify delete calls API with correct ID."""
        mock_api_client.get.return_value = existing_resource
        mock_api_client.delete("exos_interface", "res-123")
        mock_api_client.delete.assert_called_once_with("exos_interface", "res-123")

    def test_delete_nonexistent_is_noop(self, mock_api_client):
        """Verify deleting absent resource reports no change."""
        mock_api_client.get.return_value = None
        result = mock_api_client.get("exos_interface", "missing-id")
    ...
    def test_delete_api_error(self):
        ...
        with pytest.raises(Exception, match="403 Forbidden"):
            client.delete("exos_interface", "res-123")


class TestGetExosInterface:
    """Tests for getting a exos_interface."""
    ...
    def test_get_nonexistent(self, mock_api_client):
        ...
        mock_api_client.get.return_value = None
        result = mock_api_client.get("exos_interface", "nonexistent")
        assert result is None
    ...
    def test_get_api_timeout(self):
        ...
        with pytest.raises(TimeoutError):
            client.get("exos_interface", "res-123")


class TestListExosInterface:
    """Tests for listing exos_interface resources."""
...
class TestIdempotencyExosInterface:
    """Tests for idempotent behavior of exos_interface."""
    ...
    def test_create_existing_is_idempotent(self, mock_api_client, existing_resource):
        ...
        mock_api_client.get.return_value = existing_resource
        current = mock_api_client.get("exos_interface", "res-123")
    ...
    def test_delete_absent_is_idempotent(self, mock_api_client):
        ...
        mock_api_client.get.return_value = None
        exists = mock_api_client.get("exos_interface", "missing") is not None
        assert exists is False


class TestErrorHandlingExosInterface:
    """Tests for error handling in exos_interface."""
